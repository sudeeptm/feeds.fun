...
async def internal_user_id(external_user_id: str) -> UserId:
    return await get_or_create_user_id(single_user_service_id, external_user_id)


@pytest_asyncio.fixture
async def another_internal_user_id(another_external_user_id: str) -> UserId:
    return await get_or_create_user_id(single_user_service_id, another_external_user_id)
...
async def five_internal_user_ids(five_external_user_ids: list[str]) -> list[UserId]:
    return [
        await get_or_create_user_id(single_user_service_id, external_user_id)
